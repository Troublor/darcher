...
Alternatively, we provide a VirtualBox image [here on Zenodo](https://doi.org/10.5281/zenodo.5111309) (please always use the latest version on Zenodo), which contains pre-configured environment of *ĐArcher*.
