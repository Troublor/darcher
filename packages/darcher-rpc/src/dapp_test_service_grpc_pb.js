...
var dapp_test_service_pb = require('./dapp_test_service_pb.js');
var google_protobuf_empty_pb = require('google-protobuf/google/protobuf/empty_pb.js');
var common_pb = require('./common_pb.js');

function serialize_darcher_ConsoleErrorMsg(arg) {
  if (!(arg instanceof dapp_test_service_pb.ConsoleErrorMsg)) {
...
function deserialize_darcher_ConsoleErrorMsg(buffer_arg) {
  return dapp_test_service_pb.ConsoleErrorMsg.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_darcher_DAppDriverControlMsg(arg) {
  if (!(arg instanceof dapp_test_service_pb.DAppDriverControlMsg)) {
...
function deserialize_darcher_DAppDriverControlMsg(buffer_arg) {
  return dapp_test_service_pb.DAppDriverControlMsg.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_darcher_TestEndMsg(arg) {
  if (!(arg instanceof dapp_test_service_pb.TestEndMsg)) {
...
function deserialize_darcher_TestEndMsg(buffer_arg) {
  return dapp_test_service_pb.TestEndMsg.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_darcher_TestStartMsg(arg) {
  if (!(arg instanceof dapp_test_service_pb.TestStartMsg)) {
...
function deserialize_darcher_TestStartMsg(buffer_arg) {
  return dapp_test_service_pb.TestStartMsg.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_darcher_TxMsg(arg) {
  if (!(arg instanceof dapp_test_service_pb.TxMsg)) {
...
function deserialize_darcher_TxMsg(buffer_arg) {
  return dapp_test_service_pb.TxMsg.deserializeBinary(new Uint8Array(buffer_arg));
}
...
notifyTestStart: {
    ...
    requestType: dapp_test_service_pb.TestStartMsg,
...
notifyTestEnd: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: dapp_test_service_pb.TestEndMsg,
    responseType: google_protobuf_empty_pb.Empty,
...
waitForTxProcess: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: dapp_test_service_pb.TxMsg,
    responseType: google_protobuf_empty_pb.Empty,
...
dappDriverControl: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: dapp_test_service_pb.DAppDriverControlMsg,
    responseType: dapp_test_service_pb.DAppDriverControlMsg,
...
notifyConsoleError: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: dapp_test_service_pb.ConsoleErrorMsg,
    responseType: google_protobuf_empty_pb.Empty,
