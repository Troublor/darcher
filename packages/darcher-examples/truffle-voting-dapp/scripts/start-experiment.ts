...
if (require.main === module) {
    (async () => {
        const logger = new Logger("TruffleVotingDAppExperiment", "debug");
        const config = await loadConfig(path.join(__dirname, "config", "truffle-voting-dapp.config.ts"));
        const mainClass: string = "TruffleVotingDAppExperiment";
