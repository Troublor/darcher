...
if (require.main === module) {
    (async () => {
        const logger = new Logger("AuctionExperiment", "debug");
        const config = await loadConfig(path.join(__dirname, "config", "auction.config.ts"));
        const mainClass: string = "AuctionExperiment";
