...
if (require.main === module) {
    (async () => {
        const logger = new Logger("EthereumVotingDAppExperiment", "debug");
        const config = await loadConfig(path.join(__dirname, "config", "ethereum-voting-dapp.config.ts"));
        const mainClass: string = "EthereumVotingDAppExperiment";
