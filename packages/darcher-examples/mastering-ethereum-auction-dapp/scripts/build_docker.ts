...
const IMAGE_NAME = "darcher/mastering-ethereum-auction-dapp-base";
...
loadConfig(path.join(__dirname, "config", "mastering-ethereum-auction-dapp.config.ts")).then(config => {
    buildDocker(config);
});
